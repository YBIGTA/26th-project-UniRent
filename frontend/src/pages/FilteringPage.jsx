...
//   const [price, setPrice] = useState(0); // 가격 (일 당 가격)
//   const [location, setLocation] = useState(""); // 선택된 동네
//   const [ratings, setRatings] = useState([]); // 선택된 평점 리스트
